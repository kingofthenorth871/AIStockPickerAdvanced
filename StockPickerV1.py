...
def trainClassifierAndPickOutBestStocks(probability, Xval, yval, data):
    ...
    winnerStockDataFrame = pickOutWinnersBasedOnProbabilityFromClassifierPrediction(0.60, classifier, data2019cols, data2019or)
...
conditions = [
    mod_data['priceVar1yr'] > 60 , mod_data['priceVar1yr'] < 60
]
...
while len(allTickers)<15:
    winnerStockDataFrame = trainClassifierAndPickOutBestStocks(0.55, X, y, mod_data)
