...
while i < len(chunked_list):
    ...
    for t, _ in enumerate(tqdm(chunked_list[i])):
        try:
            ...
            url2 = 'https://financialmodelingprep.com/api/v3/financials/cash-flow-statement/' + chunked_list[i][t] + accessCode
            url3 = 'https://financialmodelingprep.com/api/v3/financial-ratios/' + chunked_list[i][t] + accessCode
            url4 = 'https://financialmodelingprep.com/api/v3/company-key-metrics/' + chunked_list[i][t] + accessCode
            url5 = 'https://financialmodelingprep.com/api/v3/financial-statement-growth/' + chunked_list[i][t] + accessCode
