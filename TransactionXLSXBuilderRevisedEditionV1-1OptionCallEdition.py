            ...
            if open_price is None:
                ...
                try:
                    ...
                    if (last['Close'][0]>strike):
                        putsellPriceProfitt = ((strike-last['Close'][0])/call)+1

                        putsellPriceProfitt = (((last['Close'][0]-strike)*100)/(call*100)) +1
