            ...
            if open_price is None:
                ...
                try:
                    ...
                    new_row = {
                        "date": '01/01/2019',
                        "ticker": ticker,
                        "cml_units": math.floor(USDBudgetPerStock/data.get_current_price()),     #kanskje funker den ikke?
                        "cashflow": -(data.get_current_price()*math.floor(USDBudgetPerStock/data.get_current_price())),            #kanskje funker den ikke?
                        "cml_cost": (data.get_current_price()*math.floor(USDBudgetPerStock/data.get_current_price())),
                        "currency": ticker_currency,
                        "long_name": long_name,
                        "gain_loss": pull_stock_dataProfitt(ticker, math.floor(USDBudgetPerStock/data.get_current_price()), '2019-01-01', '2020-01-01'),
                        ...
                        "yearly_high":
                            data.get_yearly_high(),

                        "fifty_day_moving_avg":
                            data.get_50day_moving_avg(),

                        "twohundred_day_moving_avg":
                            data.get_200day_moving_avg(),
